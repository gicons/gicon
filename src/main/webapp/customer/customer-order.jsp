	...
	<div class="container">
	  ...
	  <tr>
	    ...
	    <td><%=rs3.getString("orderPickupDate")%></td>
            ...
            <% ResultSet rs4=st.executeQuery("select * from payment where orderId = '"+id+"'"); 
            while(rs4.next()){
            %>
	  ...
	  <tr>
	    <th scope="row" style="width:30%;text-align:center">Payment Type</th>
	    <td><%=rs4.getString("paymentName")%></td>
	  </tr>
